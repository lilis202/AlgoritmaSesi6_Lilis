...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ArrayList<String> ListBuku = new ArrayList<String>();
        int menu = 1;
        ...
        do {
            ...
            if (menu == 1) {
                ...
                ListBuku.add("new(judul, pengarang, penerbit, kategori, tahun)");
    ...
    public static void MenampilkanDataBuku (ArrayList) {
        System.out.println("====================================================================");
